		...
		<div className="min-h-dvh flex items-center justify-center px-4">
			<div className="w-full max-w-md space-y-6 rounded-xl border border-neutral-800 bg-neutral-950 p-6">
				...
				<div className="pt-2 space-y-2">
					<button onClick={() => signIn("github", { callbackUrl: "/" })} className="w-full rounded-md bg-gray-900 p-3 text-white flex items-center justify-center gap-2 hover:bg-gray-800">
					...
					<button onClick={() => signIn("google", { callbackUrl: "/" })} className="w-full rounded-md bg-white p-3 text-gray-700 flex items-center justify-center gap-2 hover:bg-gray-50 border border-gray-200">
