		...
		<div className="min-h-dvh flex items-center justify-center px-4">
			<div className="w-full max-w-md space-y-6 rounded-xl border border-border bg-card p-6">
				...
				<div className="pt-2 space-y-2">
					...
					<button onClick={() => signIn("google", { callbackUrl: "/" })} className="w-full rounded-md bg-primary p-3 text-primary-foreground flex items-center justify-center gap-2 hover:bg-primary/90">
